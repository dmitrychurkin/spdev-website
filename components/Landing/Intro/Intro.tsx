    ...
    <Element name={ScrollLabels.ABOUT_US}>
      <section className={styles.root}>
        <Stripe className={styles.main}>
          ...
          <Link to={ScrollLabels.CONTACT_US} offset={-55} smooth={true} duration={500}>
            <Button type="button" className={styles.btn}>{t('contact_us.name', 'contact us')}</Button>
          </Link>
        </Stripe>
        <div className={styles.bottomText}>
          <Link to={ScrollLabels.SERVICES} className={styles.textLabel} offset={-55} smooth={true} duration={500}>
